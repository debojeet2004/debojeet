            ...
            <div className='py-1 w-full h-[48%] flex flex-col md:flex-row justify-between items-center'>
                ...
                <div className='w-full md:w-[64%] h-full overflow-hidden rounded-xl shadow-lg hover:scale-105 transition-transform duration-500 group'>
                    <div className='relative w-full h-full'>
                        <div className="absolute inset-0 bg-gradient-to-br from-stone-950 via-stone-800 to-stone-950 z-10 opacity-80 rounded-lg transition-opacity duration-300 group-hover:opacity-70" />
                        <Image 
                            src='/codingman.png' 
                            alt='A Developer at Work' 
                            fill
                            className='object-cover rounded-xl transition-transform duration-500 blur-[2px] group-hover:blur-none scale-110 group-hover:scale-125'
                        />
                ...
                <div className='relative cursor-pointer w-full h-[48%] rounded-lg  border-stone-700 transition-transform duration-300 hover:scale-105'>
                    ...
                    <div className="flex space-x-2">
                        ...
                        <div
                            key={country}
                            className="bg-gradient-to-r from-stone-800 to-stone-900 text-white p-2 rounded-lg shadow-md backdrop-blur-md bg-opacity-30 border border-stone-700 transition-transform duration-300 group-hover:scale-110 hover:scale-110"
                        >
                ...
                {/* BOX 3 */}
                <div className='cursor-pointer w-full h-[48%] relative flex flex-row items-center justify-end overflow-hidden rounded-lg bg-gradient-to-br from-stone-900 via-stone-800 to-stone-700 md:shadow-md transform transition-transform duration-300 hover:scale-105 group'>
            ...
            <div className='py-1 w-full h-[48%] border-red-400 flex flex-col-reverse md:flex-row justify-between items-center'>
                ...
                <div className='w-full md:w-[64%] h-full'>
                    <Card className="cursor-pointer w-full h-full overflow-hidden bg-gradient-to-br from-stone-900 via-stone-800 to-stone-700 bg-opacity-90 border-0 text-white rounded-lg shadow-xl transform transition-transform duration-300 group hover:scale-105">
                        ...
                        <CardContent className="absolute -right-5 top-36 z-10 p-2 bg-stone-900 rounded-lg font-mono text-xs border border-dashed border-stone-500 w-full max-w-[30rem] h-auto md:w-[30rem] md:h-[18rem] transform transition-transform duration-300 group-hover:translate-x-2 group-hover:translate-y-2 group-hover:scale-110">
